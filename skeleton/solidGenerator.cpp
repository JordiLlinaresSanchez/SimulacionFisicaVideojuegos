...
SolidGenerator::SolidGenerator(const Vector3& source, const Vector3& vel, physx::PxShape* shape, double lifeTime, double lifeDistance, double mass, const Vector4& color, int partsPerFrame, double genProb)
