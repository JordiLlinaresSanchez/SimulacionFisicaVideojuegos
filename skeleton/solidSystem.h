...
public:
	...
	void generateSolid();
	void addSolid(Vector3& origin, physx::PxShape* shape, Vector4 color, double lifeDistance, double lifeTime = std::numeric_limits<double>::infinity(), Vector3 vel = Vector3(0), double mass = 1.0);
